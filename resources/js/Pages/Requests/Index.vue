...
const labels = { pendiente:'Pendiente', aceptada:'Aceptada', rechazada:'Rechazada', en_camino:'En camino', entregada:'Entregada', en_uso:'En uso', para_recoger:'Para recoger', recogida:'Recogida', finalizada:'Finalizada', cancelada:'Cancelada' };
