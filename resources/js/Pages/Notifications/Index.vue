...
<template>
  ...
  <AppLayout title="Notificaciones">
    <section class="rounded-md border border-slate-200 bg-white p-5 shadow-sm">
      <div class="mb-5 flex items-center justify-between"><h2 class="flex items-center gap-2 text-lg font-semibold text-[#123f6e]"><Bell class="h-5 w-5" /> Centro de notificaciones</h2><button @click="readAll" class="inline-flex cursor-pointer items-center gap-2 rounded-md border border-[#123f6e] px-3 py-2 font-semibold text-[#123f6e] transition-colors hover:bg-[#edf3fa]"><CheckCheck class="h-4 w-4" /> Marcar todas</button></div>
