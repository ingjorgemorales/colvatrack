...
<p style="margin:0 0 8px">Para activar tu cuenta desde la APK, abre la aplicacion ColvaTrack en tu celular y selecciona <strong>Activar cuenta</strong>.</p>
...
<tr><td style="padding:4px 12px 4px 0;font-weight:600;color:#64748b">Codigo de activacion:</td><td style="padding:4px 0;font-weight:800;color:#123f6e;letter-spacing:4px">{{ $activationCode }}</td></tr>
</table>
<p style="margin:0 0 12px;padding:12px;background-color:#fef3c7;border-radius:6px;font-size:13px;color:#92400e"><strong>Importante:</strong> Con este codigo crearas tu propia contrasena. El codigo vence en 24 horas. No lo compartas con nadie.</p>
