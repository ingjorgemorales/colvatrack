...
Route::middleware(['auth', 'must.change.password', 'audit'])->group(function () {
    ...
    Route::get('/vehiculos/proyectos', [ProjectController::class, 'index'])->name('proyectos.index')->middleware('permission:proyectos,ver');
    Route::get('/vehiculos/proyectos/create', [ProjectController::class, 'create'])->name('proyectos.create')->middleware('permission:proyectos,crear');
    Route::post('/vehiculos/proyectos', [ProjectController::class, 'store'])->name('proyectos.store')->middleware('permission:proyectos,crear');
    Route::get('/vehiculos/proyectos/{project}/edit', [ProjectController::class, 'edit'])->name('proyectos.edit')->middleware('permission:proyectos,editar');
    Route::patch('/vehiculos/proyectos/{project}', [ProjectController::class, 'update'])->name('proyectos.update')->middleware('permission:proyectos,editar');
    Route::patch('/vehiculos/proyectos/{project}/estado', [ProjectController::class, 'toggleStatus'])->name('proyectos.status')->middleware('permission:proyectos,estado');
    Route::delete('/vehiculos/proyectos/{project}', [ProjectController::class, 'destroy'])->name('proyectos.destroy')->middleware('permission:proyectos,eliminar');
    ...
    Route::patch('/vehiculos/{vehiculo}/estado', [VehicleController::class, 'toggleStatus'])->name('vehiculos.status')->middleware('permission:vehiculos,estado');
    ...
    Route::post('/vehiculos/{vehicle}/reservas', [VehicleReservationController::class, 'store'])->name('vehiculos.reservas.store')->middleware('permission:reservas_vehiculos,crear');
    Route::patch('/vehiculos/{vehicle}/reservas/liberar', [VehicleReservationController::class, 'release'])->name('vehiculos.reservas.release')->middleware('permission:reservas_vehiculos,editar');
