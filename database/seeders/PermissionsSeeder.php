...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $admin=Role::where('name','Administrador')->first(); $admin?->permissions()->sync(Permission::whereIn('module',['dashboard','mapa','solicitudes','chat','notificaciones','inventario','vehiculos','reportes','usuarios','perfil'])->pluck('id'));
